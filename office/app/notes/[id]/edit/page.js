...
export default function EditNotePage() {
    ...
    if (loading) return <DashboardLayout><div className="p-10 text-gray-400">Loading...</div></DashboardLayout>;

    return (
        <DashboardLayout>
            <div className="max-w-4xl mx-auto h-[calc(100vh-100px)] flex flex-col">
                <header className="mb-6 flex justify-between items-center">
                    <Link href={`/notes/${id}`} className="text-gray-500 hover:text-gray-900 transition-colors flex items-center gap-1 font-medium">
                        ← Cancel
                    </Link>
                    <button
