    ...
    const fetchSprints = async () => {
        try {
            ...
            if (res.ok) {
                ...
                setSprints(data.sprints || []); // Use 'sprints' from new API
            }
        } catch (error) {
            console.error(error);
        } finally {
            ...
            <div className="max-w-5xl mx-auto p-4">
                ...
                {loading ? (
                    ...
                    <div className="space-y-4">
                        {sprints.map(sprint => (
                            <div key={sprint._id} className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                                <div
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-4 mt-4 md:mt-0">
                                        <button
                                            onClick={(e) => deleteSprint(sprint._id, e)}
                                        ...
                                        <div className="text-gray-400">
                                            <svg className={`w-6 h-6 transform transition-transform ${expandedSprintId === sprint._id ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
