...
export default function NoteViewPage() {
    ...
    if (loading) return <DashboardLayout><div className="p-10 text-gray-400">Loading note...</div></DashboardLayout>;
    if (!note) return <DashboardLayout><div className="p-10">Note not found</div></DashboardLayout>;
