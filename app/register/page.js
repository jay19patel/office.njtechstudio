...
export default function RegisterPage() {
    ...
    const handleRegister = (e) => {
        ...
        setTimeout(() => {
            setLoading(false);
            alert("Registration functionality under development");
        }, 500);
    };
        ...
        <div className="min-h-screen w-full flex bg-white text-gray-900 font-sans">
            ...
            <div className="hidden lg:flex w-1/2 bg-gray-50 relative overflow-hidden flex-col justify-between p-12">
                <div className="absolute inset-0 z-0">
                    <div className="absolute bottom-[-10%] right-[-10%] w-[800px] h-[800px] bg-purple-200/50 rounded-full blur-[100px] animate-pulse mix-blend-multiply" />
                    <div className="absolute top-[-10%] left-[-10%] w-[800px] h-[800px] bg-blue-200/50 rounded-full blur-[100px] animate-pulse delay-1000 mix-blend-multiply" />
                </div>
                ...
                <div className="relative z-10 max-w-lg">
                    ...
                    <p className="text-xl text-gray-600 font-medium">
                        Create an account today and start experiencing the ultimate workspace designed for productivity.
                    </p>
                </div>
